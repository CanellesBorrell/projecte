                        ...
                        <div class="sidebar-content">
                            ...
                            <ul class="chat-users clearfix">
                                ...
                                <li>
                                    <a href="javascript:void(0)" class="chat-user-online">
                                        <span></span>
                                        <img src="<?php echo base_url();?>assets/img/placeholders/avatars/avatar15.jpg" alt="avatar" class="img-circle">
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="chat-user-online">
                                        <span></span>
                                        <img src="<?php echo base_url();?>assets/img/placeholders/avatars/avatar10.jpg" alt="avatar" class="img-circle">
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="chat-user-online">
                                        <span></span>
                                        <img src="<?php echo base_url();?>assets/img/placeholders/avatars/avatar4.jpg" alt="avatar" class="img-circle">
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="javascript:void(0)" class="chat-user-busy">
                                        <span></span>
                                        <img src="<?php echo base_url();?>assets/img/placeholders/avatars/avatar16.jpg" alt="avatar" class="img-circle">
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)">
                                        <span></span>
                                        <img src="<?php echo base_url();?>assets/img/placeholders/avatars/avatar1.jpg" alt="avatar" class="img-circle">
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)">
                                ...
                                <li>
                                    <a href="javascript:void(0)">
                                        <span></span>
                                        <img src="<?php echo base_url();?>assets/img/placeholders/avatars/avatar3.jpg" alt="avatar" class="img-circle">
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)">
                                        <span></span>
                                        <img src="<?php echo base_url();?>assets/img/placeholders/avatars/avatar13.jpg" alt="avatar" class="img-circle">
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)">
                                        <span></span>
                                        <img src="<?php echo base_url();?>assets/img/placeholders/avatars/avatar5.jpg" alt="avatar" class="img-circle">
                                    </a>
                                </li>
                            </ul>
                            <!-- END Chat Users -->
                            ...
                            <div class="chat-talk display-none">
                                ...
                                <div class="chat-talk-info sidebar-section">
                                    ...
                                    <img src="<?php echo base_url();?>assets/img/placeholders/avatars/avatar5.jpg" alt="avatar" class="img-circle pull-left">
                                    <strong><?echo $Nombre;?></strong> <?echo $Apellidos;?>
                                </div>
                                <!-- END Chat Info -->
                            ...
                            <div class="sidebar-section">
                                ...
                                <div class="alert alert-success alert-alt">
                                    ...
                                    <i class="fa fa-plus fa-fw"></i> <a href="page_ready_user_profile.html"><strong><?echo $Nombre;?> <?echo $Apellidos;?></strong></a> would like to become friends!<br>
                    ...
                    <div id="sidebar-scroll">
                        ...
                        <div class="sidebar-content">
                            ...
                            <div class="sidebar-section sidebar-user clearfix sidebar-nav-mini-hide">
                                ...
                                <div class="sidebar-user-name"><?echo $Nombre;?> <?echo $Apellidos;?></div>
                            ...
                            <div class="header-section">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-lg-6 hidden-xs hidden-sm">
                                        <h1>Bienvenido <strong><?echo $Nombre;?></strong><br><small>Que tengas un buen dia!</small></h1>
                                    </div>
                                    <!-- END Main Title -->
