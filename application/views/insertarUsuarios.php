                            ...
                            <div class="row">
                                <div class="col-sm-4 col-sm-offset-1">
                                    <div class="block-section">
                                        <h3 class="sub-header text-center"><strong>Selecciona una opción</strong></h3>
                                        <h4 class="text-center">Seleccione si quiere crear un solo usuario o varios</h4></br><p class="text-center">Un usuario <label class="switch switch-info"><input type="checkbox"><span></span></label> varios usuarios</p>
                                ...
                                <div class="col-sm-6 col-sm-offset-1">
                                    ...
                                    <form id="progress-wizard" action="insertarUsuarios" method="post" class="form-horizontal">
                                        <!-- First Step -->
                                        <div id="progress-first" class="step">
											<div class="form-group">
                                                <label class="col-md-4 control-label" for="example-firstname">Nombre</label>
                                                <div class="col-md-8">
                                                    <input type="text" id="Nombre" name="Nombre" class="form-control" placeholder="John..">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-4 control-label" for="example-lastname">Apellido</label>
                                                <div class="col-md-8">
                                                    <input type="text" id="Apellido" name="Apellido" class="form-control" placeholder="Doe..">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="password" id="Contraseña" name="Contraseña" class="form-control" placeholder="Choose a crazy one..">
                                                </div>
                                            </div>
                                            <!--
                                            <div class="form-group">
                                        ...
                                        <div id="progress-second" class="step">
                                            <div class="form-group">
                                                <label class="col-md-4 control-label" for="example-address">Rol</label>
                                                <div class="col-md-8">
                                        ...
                                        <div id="progress-third" class="step">
                                            <div class="form-group">
                                                <label class="col-md-4 control-label" for="example-bio">Biografia, si cal</label>
                                                <div class="col-md-8">
                                        ...
                                        <div class="form-group form-actions">
                                            <div class="col-md-8 col-md-offset-4">
                                                ...
                                                <input type="submit" class="btn btn-sm btn-info" id="next3" value="Next">
                                            </div>
                                        </div>
                                        <!-- END Form Buttons -->
                                    </form>
